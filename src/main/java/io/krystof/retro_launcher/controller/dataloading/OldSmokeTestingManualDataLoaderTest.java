...
@Service
@Profile("oneshot")
public class OldSmokeTestingManualDataLoaderTest {
    ...
    private static final Logger log = LoggerFactory.getLogger(OldSmokeTestingManualDataLoaderTest.class);

    public OldSmokeTestingManualDataLoaderTest() throws NoSuchAlgorithmException {}
    ...
    public static void main(String[] args) {
        ...
        try {
            OldSmokeTestingManualDataLoaderTest manualDataLoaderTestService = context.getBean(OldSmokeTestingManualDataLoaderTest.class);
